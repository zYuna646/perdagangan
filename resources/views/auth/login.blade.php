                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="logo-container d-flex justify-content-center align-items-center mb-3">
                                    <img src="{{ asset('assets/images/logo.png') }}" alt="Logo Aplikasi" class="me-2" style="width: 50px; height: auto;">
                                    <img src="{{ asset('assets/images/daerah.png') }}" alt="Logo Pemerintah" style="width: 50px; height: auto;">
                                </div>
