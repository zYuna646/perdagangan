                        ...
                        <tbody>
                            @foreach ($datas as $result)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($result->tanggal_kegiatan)->format('d M Y') }}</td>
                                    <td>{{ $result->lokasi_kegiatan }}</td>
                                    <td>
                                        @if(is_array($result->foto_kegiatan) && count($result->foto_kegiatan) > 0)
                                            <div class="d-flex flex-wrap gap-2">
                                                @foreach ($result->foto_kegiatan as $foto)
