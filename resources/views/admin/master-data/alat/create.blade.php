        ...
        <form action="{{ route('admin.alat.store') }}" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   placeholder="Enter alat name" value="{{ old('name') }}" />
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_seri" class="form-control @error('no_seri') is-invalid @enderror" 
                                   placeholder="Enter serial number" value="{{ old('no_seri') }}" />
                            @error('no_seri')
                                <small class="invalid-feedback">
                                    {{ $message }}
                                </small>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" 
                                      placeholder="Enter any additional information">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <small class="invalid-feedback">
                                    {{ $message }}
                                </small>
            ...
            <div class="form-actions">
                <div class="card-body border-top d-flex justify-content-end gap-2">
                    ...
                    <button type="reset" class="btn btn-danger rounded-pill px-4 text-white">
                        Cancel
                    </button>
                </div>
            </div>
